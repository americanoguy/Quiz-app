...
const halloweenQuestionsAze = [
  ...
  { sual: "Hansı dolunay canavarlarla əlaqələndirilir?", cavablar: ["Halloween ayı", "Məhsul ayı", "Mavi ay", "Qan ayı"], duzgun: "Məhsul ayı" },
  { sual: "Cadugərlər adətən nəyin üzərində uçurlar?", cavablar: ["Süpürgə", "Maşın", "Velosiped", "At"], duzgun: "Süpürgə" },
  { sual: "Boynunda boltları olan hansı canavar tanınır?", cavablar: ["Frankenşteyn", "Drakula", "Mumiya", "Zombi"], duzgun: "Frankenşteyn" },
  { sual: "Qara rəngdən başqa ənənəvi Halloween rəngi hansıdır?", cavablar: ["Narıncı", "Yaşıl", "Bənövşəyi", "Qırmızı"], duzgun: "Narıncı" },
  { sual: "Hansı heyvan cadugərin dostu sayılır?", cavablar: ["Qara pişik", "İt", "Bayquş", "Yarasa"], duzgun: "Qara pişik" },
  { sual: "Hansı oyunda dişlə alma tutmağa çalışırsan?", cavablar: ["Alma tutma oyunu", "Alma atışı", "Alma yarışı", "Konfet axtarışı"], duzgun: "Alma tutma oyunu" },
  { sual: "Əfsanəyə görə vampirlər nə içirlər?", cavablar: ["Qan", "Su", "Süd", "Şirə"], duzgun: "Qan" },
  { sual: "Halloween gecəsində ən çox paylanan şirni hansıdır?", cavablar: ["Şokolad", "Fıstıq", "Çörək", "Pendir"], duzgun: "Şokolad" },
  { sual: "Oyulmuş balqabaq nə adlanır?", cavablar: ["Cek-fənər", "Balqabaq üzü", "Qorxulu balqabaq", "Qəribə balqabaq"], duzgun: "Cek-fənər" },
  { sual: "Hansı məxluq ay işığında ulayır?", cavablar: ["Canavar", "Ruh", "Zombi", "Vampir"], duzgun: "Canavar" },
  { sual: "Hansı fövqəltəbii varlıq tabutda yatır?", cavablar: ["Vampir", "Zombi", "Ruh", "Cadugər"], duzgun: "Vampir" },
  { sual: "Hansı konfet sarı, narıncı və ağ rəngdə olur?", cavablar: ["Qarğıdalı konfet", "Jele qurdlar", "Şokolad plitə", "Konfet çubuğu"], duzgun: "Qarğıdalı konfet" },
  { sual: "Balqabaqdan əvvəl hansı tərəvəz oyulurdu?", cavablar: ["Şalğam", "Kartof", "Kök", "Soğan"], duzgun: "Şalğam" },
  { sual: "Halloween bəzəklərində qorxulu göstərilən məşhur sehrbaz kimdir?", cavablar: ["Cadugər", "Harry Houdini", "Drakula", "Frankenşteyn"], duzgun: "Cadugər" },
  { sual: "Halloween-dən əvvəlki gecə nə adlanır?", cavablar: ["Bütün müqəddəslər gecəsi", "Halloween gecəsi", "Samhain", "Zarafat gecəsi"], duzgun: "Bütün müqəddəslər gecəsi" },
  { sual: "Hansı məxluq yalnız gümüş güllə ilə öldürülə bilər?", cavablar: ["Canavar", "Vampir", "Zombi", "Ruh"], duzgun: "Canavar" },
  { sual: "Hansı canavar bintlərlə sarınmış olur?", cavablar: ["Mumiya", "Zombi", "Frankenşteyn", "Ruh"], duzgun: "Mumiya" },
  { sual: "Hansı məşhur vampir Transilvaniyada yaşayıb?", cavablar: ["Drakula", "Count Chocula", "Nosferatu", "Edvard Kallen"], duzgun: "Drakula" },
  { sual: "Hansı konfet uzun, yumşaq və qurd formasındadır?", cavablar: ["Jele qurdlar", "Qarğıdalı konfet", "Şokolad", "Konfet çubuğu"], duzgun: "Jele qurdlar" },
  { sual: "Ruhlarla hansı səs əlaqələndirilir?", cavablar: ["Buu", "Miyau", "Vuf", "Çap"], duzgun: "Buu" },
  { sual: "Yaşıl dərili və boynunda bolt olan hansı canavar tanınır?", cavablar: ["Frankenşteyn", "Zombi", "Vampir", "Canavar"], duzgun: "Frankenşteyn" },
  { sual: "Sehr və sirr ilə hansı rəng əlaqələndirilir?", cavablar: ["Bənövşəyi", "Qırmızı", "Mavi", "Narıncı"], duzgun: "Bənövşəyi" },
  { sual: "Cadugərlərlə hansı quş əlaqələndirilir?", cavablar: ["Bayquş", "Qarğa", "Qartal", "Papuqay"], duzgun: "Bayquş" },
  { sual: "Hansı canavar qədim misir məzarlarından gəlir?", cavablar: ["Mumiya", "Vampir", "Zombi", "Ruh"], duzgun: "Mumiya" },
  { sual: "Hansı mifik varlıq yarı insan, yarı atdır?", cavablar: ["Kentavr", "Minotavr", "Qoblin", "Trol"], duzgun: "Kentavr" },
  { sual: "Hansı konfet balqabaq dadında olur?", cavablar: ["Balqabaq konfet", "Şokolad", "Sakız", "Konfet çubuğu"], duzgun: "Balqabaq konfet" },
  { sual: "Qapını döyəndə konfet istəmək üçün nə deyirlər?", cavablar: ["Trik və ya şirni", "Salam", "Buu", "Mənə konfet ver"], duzgun: "Trik və ya şirni" },
  { sual: "Hansı məxluq əfsanəyə görə yarasa insana çevrilir?", cavablar: ["Vampir", "Canavar", "Qoblin", "Zombi"], duzgun: "Vampir" },
  { sual: "Hansı oyunda asılmış şirniyyatı dişləməyə çalışırsan?", cavablar: ["Alma tutma oyunu", "Quyruq tax", "Konfet axtarışı", "Balqabaq atışı"], duzgun: "Alma tutma oyunu" },
  { sual: "Hansı canavarın başı yastıdır və bədəni tikilidir?", cavablar: ["Frankenşteyn", "Vampir", "Zombi", "Ruh"], duzgun: "Frankenşteyn" },
  { sual: "Hansı heyvan ölümün simvolu sayılır?", cavablar: ["Qara pişik", "Bayquş", "Yarasa", "İlan"], duzgun: "Qara pişik" },
  { sual: "Hansı mifik məxluq yarasaya çevrilə bilir?", cavablar: ["Vampir", "Canavar", "Zombi", "Ruh"], duzgun: "Vampir" },
  { sual: "Hansı konfet kiçik, üçbucaq formalı və rəngarəng olur?", cavablar: ["Qarğıdalı konfet", "Sakız", "Şokolad", "Konfet çubuğu"], duzgun: "Qarğıdalı konfet" },
  { sual: "Karikaturalarda hansı canavarın üzü yaşıl olur?", cavablar: ["Frankenşteyn", "Vampir", "Mumiya", "Zombi"], duzgun: "Frankenşteyn" },
  { sual: "Hansı meyvə ənənəvi olaraq alma tutma oyununda istifadə olunur?", cavablar: ["Alma", "Balqabaq", "Portağal", "Armud"], duzgun: "Alma" },
  { sual: "Hansı məxluq tabutda yatır?", cavablar: ["Vampir", "Ruh", "Zombi", "Cadugər"], duzgun: "Vampir" },
  { sual: "Halloween simvolu olaraq balqabağa nə oyulur?", cavablar: ["Cek-fənər", "Ruh", "Cadugər", "Yarasa"], duzgun: "Cek-fənər" },
  { sual: "Hansı konfet yapışqan və çeynənəndir?", cavablar: ["Jele qurdlar", "Qarğıdalı konfet", "Şokolad", "Konfet çubuğu"], duzgun: "Jele qurdlar" },
  { sual: "Hansı canavar qorxu filmlərində dirilər?", cavablar: ["Zombi", "Vampir", "Ruh", "Cadugər"], duzgun: "Zombi" },
  { sual: "Hansı quş müdriklik və gecə ilə əlaqələndirilir?", cavablar: ["Bayquş", "Qarğa", "Qartal", "Papuqay"], duzgun: "Bayquş" },
  { sual: "Hansı sehrli varlıq süpürgə ilə uçur?", cavablar: ["Cadugər", "Vampir", "Zombi", "Ruh"], duzgun: "Cadugər" },
  { sual: "Hansı canavar bintlərlə sarınmış olur?", cavablar: ["Mumiya", "Frankenşteyn", "Vampir", "Zombi"], duzgun: "Mumiya" },
  { sual: "Hansı Halloween obrazı uşaqları qorxutmaqla tanınır?", cavablar: ["Ruh", "Cadugər", "Vampir", "Balqabaq"], duzgun: "Ruh" },
  { sual: "Hansı Halloween konfet narıncı, sarı və ağ rəngdə olur?", cavablar: ["Qarğıdalı konfet", "Şokolad", "Sakız", "Konfet çubuğu"], duzgun: "Qarğıdalı konfet" },
  { sual: "Hansı mifik məxluq dolunayda ulayır?", cavablar: ["Canavar", "Vampir", "Zombi", "Ruh"], duzgun: "Canavar" },
  { sual: "Hansı rəng Halloween gecəsi ilə əlaqələndirilir?", cavablar: ["Qara", "Qırmızı", "Mavi", "Yaşıl"], duzgun: "Qara" },
  { sual: "Hansı fövqəltəbii varlıq evləri qorxutmaqla tanınır?", cavablar: ["Ruh", "Cadugər", "Vampir", "Zombi"], duzgun: "Ruh" },
  { sual: "Hansı Halloween simvolu içəridən işıqlanır?", cavablar: ["Cek-fənər", "Ruh", "Cadugər", "Balqabaq"], duzgun: "Cek-fənər" },
  { sual: "Hansı oyunda əllərsiz asılmış şirniyyatı yeməyə çalışırsan?", cavablar: ["Alma tutma oyunu", "Konfet axtarışı", "Balqabaq atışı", "Trik və ya şirni"], duzgun: "Alma tutma oyunu" },
  { sual: "Hansı canavar iti dişləri (azıqları) ilə tanınır?", cavablar: ["Vampir", "Zombi", "Frankenşteyn", "Ruh"], duzgun: "Vampir" }
];
...
const geographyQuestionsAze = [
  ...
  { sual: "Dünyanın ən kiçik ölkəsi hansıdır?", cavablar: ["Vatikan", "Monako", "Malta", "San Marino"], duzgun: "Vatikan" },
  { sual: "Dünyanın ən böyük səhrası hansıdır?", cavablar: ["Sahara", "Ərəbistan", "Qobi", "Kalahari"], duzgun: "Sahara" },
  { sual: "Everest dağı hansı dağ silsiləsində yerləşir?", cavablar: ["Himalaylar", "And", "Alplar", "Rokki"], duzgun: "Himalaylar" },
  { sual: "Ən uzun sahil xəttinə malik ölkə hansıdır?", cavablar: ["Kanada", "Avstraliya", "Rusiya", "ABŞ"], duzgun: "Kanada" },
  { sual: "“Qaranlıq qitə” adlandırılan qitə hansıdır?", cavablar: ["Afrika", "Asiya", "Avropa", "Cənubi Amerika"], duzgun: "Afrika" },
  { sual: "Yaponiyanın paytaxtı haradır?", cavablar: ["Tokio", "Pekin", "Seul", "Banqkok"], duzgun: "Tokio" },
  { sual: "Ən çox saat qurşağına malik ölkə hansıdır?", cavablar: ["Rusiya", "ABŞ", "Kanada", "Çin"], duzgun: "Rusiya" },
  { sual: "Hansı çay Misirdən axır?", cavablar: ["Nil", "Amazon", "Yanszi", "Missisipi"], duzgun: "Nil" },
  { sual: "Sahəsinə görə ən kiçik qitə hansıdır?", cavablar: ["Avstraliya", "Avropa", "Antarktida", "Cənubi Amerika"], duzgun: "Avstraliya" },
  { sual: "Fyorqları ilə məşhur olan ölkə hansıdır?", cavablar: ["Norveç", "İsveç", "Finlandiya", "İslandiya"], duzgun: "Norveç" },
  { sual: "Şimali Çin və Cənubi Monqolustanda yerləşən səhranın adı nədir?", cavablar: ["Qobi", "Sahara", "Kalahari", "Ərəbistan"], duzgun: "Qobi" },
  { sual: "Dünyanın ən böyük adası hansıdır?", cavablar: ["Qrenlandiya", "Madaqaskar", "Borneo", "Sumatra"], duzgun: "Qrenlandiya" },
  { sual: "Hansı Avropa paytaxtı Dunay çayı ilə iki yerə bölünür?", cavablar: ["Budapeşt", "Vyana", "Praqa", "Berlin"], duzgun: "Budapeşt" },
  { sual: "Ərazisinə görə ABŞ-ın ən böyük ştatı hansıdır?", cavablar: ["Alyaska", "Texas", "Kaliforniya", "Montana"], duzgun: "Alyaska" },
  { sual: "Afrikanın ən hündür dağı hansıdır?", cavablar: ["Kilimancaro", "Atlas", "Kenya", "Ruvensori"], duzgun: "Kilimancaro" },
  { sual: "“Gündoğan ölkə” adlanan ölkə hansıdır?", cavablar: ["Yaponiya", "Çin", "Tailand", "Hindistan"], duzgun: "Yaponiya" },
  { sual: "Bermuda üçbucağı hansı okeanda yerləşir?", cavablar: ["Atlantik", "Sakit", "Hind", "Arktika"], duzgun: "Atlantik" },
  { sual: "Ən çox piramidaları olan ölkə hansıdır?", cavablar: ["Sudan", "Misir", "Meksika", "Peru"], duzgun: "Sudan" },
  { sual: "Dünyanın ən hündür şəlaləsi hansıdır?", cavablar: ["Anhel", "Niagara", "İquasu", "Viktoriya"], duzgun: "Anhel" },
  { sual: "Böyük Sədd Rifi hansı ölkədə yerləşir?", cavablar: ["Avstraliya", "ABŞ", "Cənubi Afrika", "Braziliya"], duzgun: "Avstraliya" },
  { sual: "Bayrağında ağcaqayın yarpağı olan ölkə hansıdır?", cavablar: ["Kanada", "ABŞ", "Böyük Britaniya", "Almaniya"], duzgun: "Kanada" },
  { sual: "Afrikanın ərazi baxımından ən böyük ölkəsi hansıdır?", cavablar: ["Əlcəzair", "Sudan", "Liviya", "Misir"], duzgun: "Əlcəzair" },
  { sual: "Geizerləri və Yellowstone Parkı ilə məşhur olan ABŞ ştatı hansıdır?", cavablar: ["Vayominq", "Kaliforniya", "Montana", "Alyaska"], duzgun: "Vayominq" },
  { sual: "Ən çox vulkana malik Avropa ölkəsi hansıdır?", cavablar: ["İtaliya", "İslandiya", "Yunanıstan", "İspaniya"], duzgun: "İtaliya" },
  { sual: "Paris şəhərindən hansı çay axır?", cavablar: ["Sena", "Temza", "Dunay", "Reyn"], duzgun: "Sena" },
  { sual: "Afrikanın ən böyük gölü hansıdır?", cavablar: ["Viktoriya gölü", "Tanganika gölü", "Malavi gölü", "Çad gölü"], duzgun: "Viktoriya gölü" },
  { sual: "Fransa ilə İspaniya arasında yerləşən dağ silsiləsi hansıdır?", cavablar: ["Piriney", "Alplar", "Karpat", "Apenin"], duzgun: "Piriney" },
  { sual: "ABŞ-da 'Böyük Palçıqlı' adlandırılan çay hansıdır?", cavablar: ["Missuri", "Missisipi", "Kolorado", "Rio Qrande"], duzgun: "Missuri" },
  { sual: "Ən uzun sahil xəttinə malik Avropa ölkəsi hansıdır?", cavablar: ["Norveç", "Yunanıstan", "İtaliya", "İspaniya"], duzgun: "Norveç" },
  { sual: "Şimali Amerikada yerləşən səhranın adı nədir?", cavablar: ["Mohave", "Sahara", "Qobi", "Kalahari"], duzgun: "Mohave" },
  { sual: "Dünyanın ən kiçik okeanı hansıdır?", cavablar: ["Arktika", "Atlantik", "Hind", "Sakit"], duzgun: "Arktika" },
  { sual: "Avropada ən çox əhalisi olan ölkə hansıdır?", cavablar: ["Almaniya", "Fransa", "Böyük Britaniya", "İtaliya"], duzgun: "Almaniya" },
  { sual: "Hindistanın cənubunda yerləşən ada ölkə hansıdır?", cavablar: ["Şri Lanka", "Maldiv", "İndoneziya", "Yaponiya"], duzgun: "Şri Lanka" },
  { sual: "“Gecə günəşi ölkəsi” adlanan ölkə hansıdır?", cavablar: ["Norveç", "İsveç", "Finlandiya", "İslandiya"], duzgun: "Norveç" },
  { sual: "ABŞ ilə Meksika arasındakı sərhədi hansı çay təşkil edir?", cavablar: ["Rio Qrande", "Missisipi", "Kolorado", "Missuri"], duzgun: "Rio Qrande" },
  { sual: "Ən çox adaya malik ölkə hansıdır?", cavablar: ["İsveç", "İndoneziya", "Kanada", "Filippin"], duzgun: "İsveç" },
  { sual: "Tanzaniya, Uqanda və Keniya arasında paylaşılan göl hansıdır?", cavablar: ["Viktoriya gölü", "Tanganika gölü", "Malavi gölü", "Turkana gölü"], duzgun: "Viktoriya gölü" },
  { sual: "ABŞ-ın qərbində yerləşən dağ silsiləsi hansıdır?", cavablar: ["Rokki", "Appalaç", "Sierra Nevada", "Alplar"], duzgun: "Rokki" },
  { sual: "Asiyada ən çox vulkana malik ölkə hansıdır?", cavablar: ["İndoneziya", "Yaponiya", "Filippin", "Çin"], duzgun: "İndoneziya" },
  { sual: "“Kanallar şəhəri” adlanan Avropa paytaxtı hansıdır?", cavablar: ["Venesiya", "Amsterdam", "Brügge", "Stokholm"], duzgun: "Venesiya" },
  { sual: "Cənubi Amerikanın ən böyük ölkəsi hansıdır?", cavablar: ["Braziliya", "Argentina", "Peru", "Kolumbiya"], duzgun: "Braziliya" },
  { sual: "Avropa və Asiyanı ayıran boğaz hansıdır?", cavablar: ["Bosfor", "Malakka", "Cəbəllütariq", "Hörmüz"], duzgun: "Bosfor" },
  { sual: "ABŞ-ın cənub-qərbində yerləşən səhranın adı nədir?", cavablar: ["Sonora", "Sahara", "Qobi", "Kalahari"], duzgun: "Sonora" },
  { sual: "Geiranger fyorqları ilə məşhur ölkə hansıdır?", cavablar: ["Norveç", "İslandiya", "Finlandiya", "İsveç"], duzgun: "Norveç" },
  { sual: "London şəhərindən hansı çay axır?", cavablar: ["Temza", "Sena", "Dunay", "Reyn"], duzgun: "Temza" },
  { sual: "Böyük Göllər ilə məşhur olan ABŞ ştatı hansıdır?", cavablar: ["Mişiqan", "Nyu-York", "Ohayo", "Viskonsin"], duzgun: "Mişiqan" },
  { sual: "Dünyanın ən hündür dağı hansıdır?", cavablar: ["Everest", "K2", "Kançencunqa", "Lxotse"], duzgun: "Everest" },
  { sual: "Venesiya, Florensiya və Roma hansı ölkədə yerləşir?", cavablar: ["İtaliya", "İspaniya", "Fransa", "Portuqaliya"], duzgun: "İtaliya" },
  { sual: "Amazon meşələri ilə məşhur Cənubi Amerika ölkəsi hansıdır?", cavablar: ["Braziliya", "Peru", "Kolumbiya", "Venesuela"], duzgun: "Braziliya" },
  { sual: "Hind okeanında yerləşən və çayı ilə məşhur ada ölkə hansıdır?", cavablar: ["Şri Lanka", "Maldiv", "Mavritaniya", "Seyşel"], duzgun: "Şri Lanka" },
  { sual: "Qahirədən hansı çay axır?", cavablar: ["Nil", "Amazon", "Yanszi", "Missisipi"], duzgun: "Nil" },
  { sual: "Dünyanın ən böyük ölkəsi hansıdır?", cavablar: ["Rusiya", "Kanada", "ABŞ", "Çin"], duzgun: "Rusiya" }
];
...
const historyQuestionsAze = [
  ...
  { sual: "Berlin divarı hansı ildə dağıldı?", cavablar: ["1989", "1991", "1985", "1979"], duzgun: "1989" },
  { sual: "‘Orlean Qızı’ kimi kim tanınırdı?", cavablar: ["Janna d’Ark", "Kraliça I Yelizaveta", "Kleopatra", "Mariya Antuanetta"], duzgun: "Janna d’Ark" },
  { sual: "ABŞ-da Şimal və Cənub arasında hansı müharibə baş verdi?", cavablar: ["Vətəndaş Müharibəsi", "I Dünya Müharibəsi", "İnqilab Müharibəsi", "1812 Müharibəsi"], duzgun: "Vətəndaş Müharibəsi" },
  { sual: "Aya ilk ayaq basan insan kim idi?", cavablar: ["Nil Armstronq", "Buzz Aldrin", "Yuri Qaqarin", "Maykl Kollins"], duzgun: "Nil Armstronq" },
  { sual: "Titanik nə vaxt batdı?", cavablar: ["1912", "1905", "1920", "1898"], duzgun: "1912" },
  { sual: "Romalıların ilk imperatoru kim idi?", cavablar: ["Avqust", "Nero", "Kaligula", "Yuli Sezar"], duzgun: "Avqust" },
  { sual: "Amerika Vətəndaş Müharibəsi hansı ildə başladı?", cavablar: ["1861", "1776", "1812", "1848"], duzgun: "1861" },
  { sual: "Müstəqillik Bəyannaməsini kim yazıb?", cavablar: ["Tomas Cefferson", "Benjamin Franklin", "Con Adams", "Ceyms Madison"], duzgun: "Tomas Cefferson" },
  { sual: "Hansı müharibə Versal müqaviləsi ilə başa çatdı?", cavablar: ["I Dünya Müharibəsi", "II Dünya Müharibəsi", "Napoleon Müharibələri", "Soyuq Müharibə"], duzgun: "I Dünya Müharibəsi" },
  { sual: "Rusiyanın son çarı kim idi?", cavablar: ["II Nikolay", "III Aleksandr", "I Pyotr", "IV İvan"], duzgun: "II Nikolay" },
  { sual: "Piramidaları hansı qədim sivilizasiya inşa edib?", cavablar: ["Misirlilər", "Mesopotamiyalılar", "Romalılar", "Yunanlar"], duzgun: "Misirlilər" },
  { sual: "II Dünya Müharibəsi dövründə Britaniyanın baş naziri kim idi?", cavablar: ["Uinston Çörçill", "Nevil Çemberlen", "Klement Ettli", "Toni Bler"], duzgun: "Uinston Çörçill" },
  { sual: "Çingiz Xan hansı imperiyanı idarə edirdi?", cavablar: ["Monqol İmperiyası", "Osmanlı İmperiyası", "Fars İmperiyası", "Roma İmperiyası"], duzgun: "Monqol İmperiyası" },
  { sual: "Böyük Britaniyanın ilk qadın baş naziri kim idi?", cavablar: ["Marqaret Tetçer", "Tereza Mey", "Anqela Merkel", "İndira Qandi"], duzgun: "Marqaret Tetçer" },
  { sual: "Napoleonun hakimiyyətinə son qoyan döyüş hansıdır?", cavablar: ["Waterloo Döyüşü", "Trafalqar Döyüşü", "Leypsiq Döyüşü", "Austerlitz Döyüşü"], duzgun: "Waterloo Döyüşü" },
  { sual: "Birləşmiş Millətlər Təşkilatı nə vaxt yaradıldı?", cavablar: ["1945", "1919", "1939", "1950"], duzgun: "1945" },
  { sual: "Almaniyanın ilk kansleri kim idi?", cavablar: ["Otto fon Bismark", "Anqela Merkel", "Adolf Hitlər", "Konrad Adenauer"], duzgun: "Otto fon Bismark" },
  { sual: "Çinin Böyük Divarını hansı sülalə tikdi?", cavablar: ["Çin (Qin) sülaləsi", "Han sülaləsi", "Tanq sülaləsi", "Minq sülaləsi"], duzgun: "Çin (Qin) sülaləsi" },
  { sual: "1917-ci ildə Rusiya inqilabına kim rəhbərlik etdi?", cavablar: ["Vladimir Lenin", "İosif Stalin", "Lev Trotski", "II Nikolay"], duzgun: "Vladimir Lenin" },
  { sual: "Maqna Kartası nə vaxt imzalanıb?", cavablar: ["1215", "1066", "1492", "1776"], duzgun: "1215" },
  { sual: "Apartheiddən sonra Cənubi Afrikanın ilk prezidenti kim idi?", cavablar: ["Nelson Mandela", "F. V. de Klerk", "Tabo Mbeki", "Siril Ramafosa"], duzgun: "Nelson Mandela" },
  { sual: "Mixi yazını hansı sivilizasiya yaradıb?", cavablar: ["Şumerlər", "Misirlilər", "Romalılar", "Yunanlar"], duzgun: "Şumerlər" },
  { sual: "Penisillini kim kəşf etdi?", cavablar: ["Aleksandr Fleminq", "Luis Paster", "Mari Küri", "Tomas Edison"], duzgun: "Aleksandr Fleminq" },
  { sual: "1939–1945 illər arasında hansı müharibə baş verib?", cavablar: ["II Dünya Müharibəsi", "I Dünya Müharibəsi", "Koreya Müharibəsi", "Vyetnam Müharibəsi"], duzgun: "II Dünya Müharibəsi" },
  { sual: "Monqol İmperiyasının banisi kim idi?", cavablar: ["Çingiz Xan", "Kublay Xan", "Teymur", "Atilla"], duzgun: "Çingiz Xan" },
  { sual: "Hindistan müstəqilliyini hansı ildə qazandı?", cavablar: ["1947", "1950", "1935", "1945"], duzgun: "1947" },
  { sual: "Türkiyə Respublikasının ilk prezidenti kim idi?", cavablar: ["Mustafa Kamal Atatürk", "Sukarno", "Ho Şi Min", "Rza şah"], duzgun: "Mustafa Kamal Atatürk" },
  { sual: "1066-cı ildə İngiltərədə hansı döyüş baş verib?", cavablar: ["Hastinqs Döyüşü", "Ajinkur Döyüşü", "Waterloo Döyüşü", "Tur Döyüşü"], duzgun: "Hastinqs Döyüşü" },
  { sual: "Çap maşınını kim ixtira edib?", cavablar: ["Yohannes Qutenberq", "Leonardo da Vinçi", "İsaak Nyuton", "Qalileo Qaliley"], duzgun: "Yohannes Qutenberq" },
  { sual: "Süleyman Qanuni hansı imperiyanı idarə edirdi?", cavablar: ["Osmanlı İmperiyası", "Roma İmperiyası", "Fars İmperiyası", "Monqol İmperiyası"], duzgun: "Osmanlı İmperiyası" },
  { sual: "Misirin məşhur qadın fironu kim idi?", cavablar: ["Hatshepsut", "Kleopatra", "Nefertiti", "Nefertari"], duzgun: "Hatshepsut" },
  { sual: "1815-ci ildə Napoleonun məğlubiyyəti ilə bitən müharibə hansıdır?", cavablar: ["Napoleon Müharibələri", "I Dünya Müharibəsi", "II Dünya Müharibəsi", "Yeddiillik Müharibə"], duzgun: "Napoleon Müharibələri" },
  { sual: "Çinin ilk imperatoru kim idi?", cavablar: ["Qin Şi Xuandi", "Han Vudi", "Kanqsi", "Yuan Şizu"], duzgun: "Qin Şi Xuandi" },
  { sual: "Soyuq Müharibə rəsmi olaraq nə vaxt başa çatdı?", cavablar: ["1991", "1989", "1990", "1992"], duzgun: "1991" },
  { sual: "II Dünya Müharibəsi zamanı Sovet İttifaqına kim rəhbərlik edirdi?", cavablar: ["İosif Stalin", "Vladimir Lenin", "Lev Trotski", "Nikita Xruşşov"], duzgun: "İosif Stalin" },
  { sual: "Azadlıq Bəyannaməsini kim imzalayıb?", cavablar: ["Abraham Linkoln", "Corc Vaşinqton", "Tomas Cefferson", "Ceyms Madison"], duzgun: "Abraham Linkoln" },
  { sual: "Yer kürəsini ilk dəfə kim dolandı?", cavablar: ["Ferdinand Magellan", "Kristofor Kolumb", "Ceyms Kuk", "Marko Polo"], duzgun: "Ferdinand Magellan" },
  { sual: "1929-cu il 29 oktyabrda hansı hadisə baş verdi?", cavablar: ["Uol Strit böhranı", "Fransız İnqilabı", "Londonun Böyük Yanğını", "Boston Çay Partiyası"], duzgun: "Uol Strit böhranı" },
  { sual: "ABŞ-ın impiçment olunan ilk prezidenti kim idi?", cavablar: ["Endryu Conson", "Riçard Nikson", "Bill Klinton", "Donald Tramp"], duzgun: "Endryu Conson" },
  { sual: "İsgəndər Makedoniyalı hansı imperiyanı idarə edirdi?", cavablar: ["Makedoniya İmperiyası", "Roma İmperiyası", "Fars İmperiyası", "Misir İmperiyası"], duzgun: "Makedoniya İmperiyası" },
  { sual: "Berlin divarı ilə hansı ölkə bölünmüşdü?", cavablar: ["Almaniya", "Koreya", "Vyetnam", "İrlandiya"], duzgun: "Almaniya" },
  { sual: "“İliada” və “Odisseya”nı kim yazıb?", cavablar: ["Homer", "Virgil", "Sofokl", "Platon"], duzgun: "Homer" },
  { sual: "Amerika İnqilabı dövründə hansı döyüş baş verib?", cavablar: ["Banker Hill Döyüşü", "Gettisburq Döyüşü", "Yorktaun Döyüşü", "Midvey Döyüşü"], duzgun: "Banker Hill Döyüşü" },
  { sual: "Hindistanın ilk baş naziri kim idi?", cavablar: ["Cəvahirləl Nehru", "Mahatma Qandi", "İndira Qandi", "Raciv Qandi"], duzgun: "Cəvahirləl Nehru" },
  { sual: "Maçu Pikçu şəhərini hansı sivilizasiya tikib?", cavablar: ["İnka", "Maya", "Astek", "Olmek"], duzgun: "İnka" },
  { sual: "1783-cü ildə Paris Müqaviləsini kim imzaladı?", cavablar: ["Amerika Birləşmiş Ştatları", "Fransa", "Böyük Britaniya", "İspaniya"], duzgun: "Amerika Birləşmiş Ştatları" },
  { sual: "Perestroykanı hansı rus lideri başlatdı?", cavablar: ["Mixail Qorbaçov", "Vladimir Putin", "Boris Yeltsin", "Lev Trotski"], duzgun: "Mixail Qorbaçov" },
  { sual: "Yaponiyanın ilk imperatoru kim idi?", cavablar: ["İmperator Cimmu", "İmperator Meyci", "İmperator Hirohito", "İmperator Tayşo"], duzgun: "İmperator Cimmu" },
  { sual: "Bizans İmperiyasının paytaxtı hansı şəhər idi?", cavablar: ["Konstantinopol", "Roma", "Afina", "İsgəndəriyyə"], duzgun: "Konstantinopol" },
  { sual: "Fransanın ilk prezidenti kim idi?", cavablar: ["Luis-Napoleon Bonapart", "Şarl de Qoll", "Jorj Klemonso", "Napoleon Bonapart"], duzgun: "Luis-Napoleon Bonapart" }
];
...
const movieQuestionsAze = [
  ...
  { sual: "'Harri Potter' filmində Hermione obrazını kim canlandırıb?", cavablar: ["Emma Watson", "Emma Stone", "Natalie Portman", "Jennifer Lawrence"], duzgun: "Emma Watson" },
  { sual: "İlk 'Qisasçılar' (Avengers) filmi hansı ildə çıxıb?", cavablar: ["2010", "2012", "2015", "2008"], duzgun: "2012" },
  { sual: "Hansı film seriyasında 'Frodo Baqqins' obrazı var?", cavablar: ["Harri Potter", "Üzüklərin hökmdarı", "Hobbit", "Persi Cekson"], duzgun: "Üzüklərin hökmdarı" },
  { sual: "'Yura Parkı' (Jurassic Park) filmini kim çəkib?", cavablar: ["Steven Spielberg", "James Cameron", "Peter Jackson", "Ridley Scott"], duzgun: "Steven Spielberg" },
  { sual: "Hansı filmdə 'Let It Go' mahnısı var?", cavablar: ["Qarışıq", "Buzlaşma (Frozen)", "Moana", "Cəsur (Brave)"], duzgun: "Buzlaşma (Frozen)" },
  { sual: "'Qaranlıq Cəngavər' (The Dark Knight) filmini kim çəkib?", cavablar: ["Christopher Nolan", "Tim Burton", "Zack Snyder", "Guy Ritchie"], duzgun: "Christopher Nolan" },
  { sual: "'Dəmir Adam' (Iron Man) filmində Toni Stark obrazını kim oynayıb?", cavablar: ["Robert Downey Jr.", "Chris Evans", "Chris Hemsworth", "Mark Ruffalo"], duzgun: "Robert Downey Jr." },
  { sual: "1994-cü ildə Oskar 'Ən Yaxşı Film' mükafatını hansı film qazandı?", cavablar: ["Forrest Gump", "Pulp Fiction", "The Shawshank Redemption", "Speed"], duzgun: "Forrest Gump" },
  { sual: "'Matrisa' (The Matrix) filmində Neo obrazını kim oynayıb?", cavablar: ["Keanu Reeves", "Brad Pitt", "Will Smith", "Johnny Depp"], duzgun: "Keanu Reeves" },
  { sual: "Xəyalı Vakanqa krallığı haqqında hansı filmdir?", cavablar: ["Qara Panter (Black Panther)", "Tor", "Qadın Möcüzə (Wonder Woman)", "Doktor Strenc"], duzgun: "Qara Panter (Black Panther)" },
  { sual: "'Avatar' filmini kim çəkib?", cavablar: ["James Cameron", "Steven Spielberg", "Peter Jackson", "Ridley Scott"], duzgun: "James Cameron" },
  { sual: "Hansı filmdə 'Mən qayıdacağam' (I'll be back) ifadəsi səslənir?", cavablar: ["Terminator", "Yırtıcı (Predator)", "RoboCop", "Total Recall"], duzgun: "Terminator" },
  { sual: "Əsl 'Aslan Kralı' filmində Simba obrazını kim səsləndirib?", cavablar: ["Matthew Broderick", "James Earl Jones", "Jeremy Irons", "Jonathan Taylor Thomas"], duzgun: "Matthew Broderick" },
  { sual: "Hansı filmdə Cek Sparrow obrazı var?", cavablar: ["Karib dənizinin quldurları", "Hobbit", "Üzüklərin hökmdarı", "Harri Potter"], duzgun: "Karib dənizinin quldurları" },
  { sual: "Quentin Tarantino tərəfindən çəkilmiş film hansıdır?", cavablar: ["Pulp Fiction", "Inception", "Avatar", "The Dark Knight"], duzgun: "Pulp Fiction" },
  { sual: "'Forrest Gump' obrazını kim oynayıb?", cavablar: ["Tom Hanks", "Brad Pitt", "Leonardo DiCaprio", "Johnny Depp"], duzgun: "Tom Hanks" },
  { sual: "Hansı film DeLorean vaxt maşını haqqındadır?", cavablar: ["Gələcəyə Qayıdış (Back to the Future)", "Terminator", "Matrisa", "Ulduzlararası (Interstellar)"], duzgun: "Gələcəyə Qayıdış (Back to the Future)" },
  { sual: "'Harri Potter' obrazını kim oynayıb?", cavablar: ["Daniel Radcliffe", "Rupert Grint", "Tom Felton", "Elijah Wood"], duzgun: "Daniel Radcliffe" },
  { sual: "Hansı film 'Pequod' adlı gəmi haqqındadır?", cavablar: ["Mobi Dik", "Titanik", "Karib dənizinin quldurları", "Çənə (Jaws)"], duzgun: "Mobi Dik" },
  { sual: "'Şindlerin Siyahısı' (Schindler's List) filmini kim çəkib?", cavablar: ["Steven Spielberg", "Martin Scorsese", "Clint Eastwood", "Ridley Scott"], duzgun: "Steven Spielberg" },
  { sual: "Lin-Manuel Miranda tərəfindən hazırlanan musiqili film hansıdır?", cavablar: ["Hamilton", "In the Heights", "Dear Evan Hansen", "West Side Story"], duzgun: "In the Heights" },
  { sual: "Hansı film King Kong haqqındadır?", cavablar: ["King Kong", "Godzilla", "Yura Parkı", "Avatar"], duzgun: "King Kong" },
  { sual: "'Qaranlıq Cəngavər'də Joker obrazını kim oynayıb?", cavablar: ["Heath Ledger", "Joaquin Phoenix", "Jack Nicholson", "Jared Leto"], duzgun: "Heath Ledger" },
  { sual: "Hansı cizgi filmində Olaf adlı qardan adam var?", cavablar: ["Frozen", "Tangled", "Moana", "Coco"], duzgun: "Frozen" },
  { sual: "'Üzüklərin hökmdarı' filmində Gandalf obrazını kim oynayıb?", cavablar: ["Ian McKellen", "Christopher Lee", "Viggo Mortensen", "Orlando Bloom"], duzgun: "Ian McKellen" },
  { sual: "Hansı film üzüyün məhv edilməsindən bəhs edir?", cavablar: ["Üzüklərin hökmdarı", "Harri Potter", "Hobbit", "Persi Cekson"], duzgun: "Üzüklərin hökmdarı" },
  { sual: "'Titanik' filmini kim çəkib?", cavablar: ["James Cameron", "Steven Spielberg", "Peter Jackson", "Christopher Nolan"], duzgun: "James Cameron" },
  { sual: "Hansı film Elsadan bəhs edir?", cavablar: ["Buzlaşma (Frozen)", "Qarışıq (Tangled)", "Moana", "Cəsur (Brave)"], duzgun: "Buzlaşma (Frozen)" },
  { sual: "2017-ci ildə çıxan 'Qadın Möcüzə' filmində Wonder Woman obrazını kim oynayıb?", cavablar: ["Gal Gadot", "Margot Robbie", "Scarlett Johansson", "Emma Watson"], duzgun: "Gal Gadot" },
  { sual: "Hansı film seriyasında 'Bilbo Baqqins' obrazı var?", cavablar: ["Hobbit", "Üzüklərin hökmdarı", "Harri Potter", "Narniya"], duzgun: "Hobbit" },
  { sual: "'Dunkirk' filmini kim çəkib?", cavablar: ["Christopher Nolan", "Steven Spielberg", "James Cameron", "Ridley Scott"], duzgun: "Christopher Nolan" },
  { sual: "Hansı film yuxular içində yuxulardan bəhs edir?", cavablar: ["Inception", "Matrix", "Shutter Island", "Interstellar"], duzgun: "Inception" },
  { sual: "'Oyun Oyuncağı' filmində Woody obrazını kim səsləndirib?", cavablar: ["Tom Hanks", "Tim Allen", "Billy Crystal", "John Goodman"], duzgun: "Tom Hanks" },
  { sual: "Hansı film 'Pandora' adlı planetdə cərəyan edir?", cavablar: ["Avatar", "Star Wars", "Guardians of the Galaxy", "Interstellar"], duzgun: "Avatar" },
  { sual: "'Qladiator' filmini kim çəkib?", cavablar: ["Ridley Scott", "Steven Spielberg", "James Cameron", "Christopher Nolan"], duzgun: "Ridley Scott" },
  { sual: "Hansı film 'Qüvvə səninlə olsun' ifadəsi ilə məşhurdur?", cavablar: ["Ulduz Müharibələri (Star Wars)", "Star Trek", "Qalaktikanın Qəyyumları", "Qisasçılar"], duzgun: "Ulduz Müharibələri (Star Wars)" },
  { sual: "'Dəmir Adam' obrazını kim oynayıb?", cavablar: ["Robert Downey Jr.", "Chris Evans", "Chris Hemsworth", "Mark Ruffalo"], duzgun: "Robert Downey Jr." },
  { sual: "Hansı film 'Qara İnci' adlı gəmiyə aiddir?", cavablar: ["Karib dənizinin quldurları", "Titanik", "Poseydon Macərası", "Mobi Dik"], duzgun: "Karib dənizinin quldurları" },
  { sual: "'Parıltı' (The Shining) filmini kim çəkib?", cavablar: ["Stanley Kubrick", "Alfred Hitchcock", "Martin Scorsese", "Ridley Scott"], duzgun: "Stanley Kubrick" },
  { sual: "Hansı cizgi filmində Mayk və Sallinin obrazları var?", cavablar: ["Monsters, Inc.", "Toy Story", "Finding Nemo", "Shrek"], duzgun: "Monsters, Inc." },
  { sual: "Kapitan Cek Sparrow obrazını kim oynayıb?", cavablar: ["Johnny Depp", "Orlando Bloom", "Geoffrey Rush", "Ian McShane"], duzgun: "Johnny Depp" },
  { sual: "Hansı film basketbol komandasının çətinlikləri aşmasından bəhs edir?", cavablar: ["Space Jam", "Coach Carter", "Titans-ı xatırla", "Hoosiers"], duzgun: "Titans-ı xatırla" },
  { sual: "'Pulp Fiction' filmini kim çəkib?", cavablar: ["Quentin Tarantino", "Steven Spielberg", "James Cameron", "Christopher Nolan"], duzgun: "Quentin Tarantino" },
  { sual: "Hansı film gənc sehrbaz Harri haqqında danışır?", cavablar: ["Harri Potter", "Persi Cekson", "Sehrbazın Şagirdi", "Fantastik Heyvanlar"], duzgun: "Harri Potter" },
  { sual: "'Qara Panter' obrazını kim oynayıb?", cavablar: ["Chadwick Boseman", "Michael B. Jordan", "Anthony Mackie", "Chris Evans"], duzgun: "Chadwick Boseman" },
  { sual: "Hansı film Elsə və Anna obrazlarını ehtiva edir?", cavablar: ["Frozen", "Tangled", "Moana", "Brave"], duzgun: "Frozen" }
];
